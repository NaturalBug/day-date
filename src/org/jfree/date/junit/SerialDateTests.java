...
public class SerialDateTests extends TestCase {
	...
	/**
	 * Test the conversion of a string to a weekday. Note that this test will fail
	 * if the
	...
	/**
	 * Test the conversion of a string to a month. Note that this test will fail if
	 * the
	...
	/**
	 * A test for bug report 1096 (now fixed).
	 */
